...
def main():
    ...
    if upload_file:
        ...
        if error:
            ...
            # logging.error("Schema error in the Excel file")
            # sentry_sdk.capture_message("Wrong schema in the Excel file")
        elif ui.display_save_button():
            excel_to_sql(df)
            ui.display_success_message()
            # logging.info(" Successfully sent to the database")
            # sentry_sdk.capture_message("Data sent to the database")
